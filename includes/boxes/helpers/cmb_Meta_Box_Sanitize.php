...
class cmb_Meta_Box_Sanitize {
	...
	public function __construct( $field, $value ) {
		$this->field       = $field;
		$this->value       = $value;
		$this->object_id   = Jseacgp_Meta_Box::get_object_id();
		$this->object_type = Jseacgp_Meta_Box::get_object_type();
	}
	...
	public function _save_file_id( $value ) {
		...
		if ( $group ) {
			...
			$id_val = isset( $_POST[ $field->id() ] ) ? sanitize_text_field($_POST[ $field->id() ]) : null;
